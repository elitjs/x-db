...
typescript/            npm package "@elitjs/xdb": TS wrapper + tests + example
```
...
```ts
import { writeTable, XdbReader } from "@elitjs/xdb";
...
import { mergeTables } from "@elitjs/xdb";
...
```ts
import { XdbSingleFile, XdbReader } from "@elitjs/xdb";
...
```ts
import { XdbStore } from "@elitjs/xdb";
