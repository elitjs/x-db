...
|---|---:|---:|---:|---:|---:|---:|
| **x-db (sync)** | ~1,000,000* | ~5,000* | ~1,000,000* | ~1,100,000* | **414** | **362** |
| **x-db (nosync)** | 5,566 | 2,294 | 4,523 | 5,944 | **463** | **335** |
| SQLite (WAL+NORMAL) | 20,343 | 1,044 | 16,610 | 17,365 | 2,571 | 2,235 |
| redb (txn/op) | 1,162,259* | 3,579 | 1,167,334* | 1,203,711* | 443 | 389 |
| HashMap (RAM) | 246 | — | 313 | 273 | 258 | — |
